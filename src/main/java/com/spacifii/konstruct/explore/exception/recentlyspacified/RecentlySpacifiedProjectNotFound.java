 ...
 */
public class RecentlySpacifiedProjectNotFound extends RuntimeException implements ApiException {

    private static final APIResponseKey purpose = APIResponseKey.RECENTLY_SPACIFIED_PROJECT_NOT_FOUND;
