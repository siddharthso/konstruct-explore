...
public class MediaQuestion {
    ...
    public void convertMediaUserACtionToMediaQuestion(MediaUserAction mediaUserAction){
    ...
    public MediaQuestion(Boolean isAskedByMe, UserProfileMiniDto questionProfile, UserProfileMiniDto answerProfile) {
        this.isAskedByMe = isAskedByMe;
        this.questionProfile = questionProfile;
        this.answerProfile = answerProfile;
    }

    public MediaQuestion(String mediaId, String questionId, String answer, String question, Boolean isAskedByMe, UserProfileMiniDto questionProfile, UserProfileMiniDto answerProfile, Long creationDate, Long lastModifiedDate) {
