...
public class ConceptBoardMediaReview {
    ...
    public void convertMediaUserActionToMediaReview(ConceptBoardMediaUserAction mediaUserAction){
    ...
    public ConceptBoardMediaReview() {
    }

    public ConceptBoardMediaReview(Boolean isAskedByMe, UserProfileMiniDto userProfile) {
        this.isAskedByMe = isAskedByMe;
        this.userProfile = userProfile;
    }

    public ConceptBoardMediaReview(String reviewId, String mediaId, BigDecimal ratings, BigDecimal outOf, String review, Boolean isAskedByMe, UserProfileMiniDto userProfile, Long creationDate, Long lastModifiedDate) {
