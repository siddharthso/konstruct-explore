...
public class ConceptBoardMediaComment {
    ...
    public ConceptBoardMediaComment(String mediaId, String commentId, String comment, String parentCommentId) {
    ...
    public ConceptBoardMediaComment(String mediaId, String commentId, String comment, String parentCommentId, String name, String email) {
        this.mediaId = mediaId;
        this.commentId = commentId;
        this.comment = comment;
        this.parentCommentId = parentCommentId;
    ...
    public void convertConceptBoardMediaUserActionToConceptBoardMediaComment(ConceptBoardMediaUserAction mediaUserAction) {
    ...
    public ConceptBoardMediaComment(Boolean isAskedByMe, UserProfileMiniDto userProfile) {
    ...
    public ConceptBoardMediaComment() {
    }
