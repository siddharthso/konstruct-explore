...
@Service("SaveProjectUserActionCommentStrategy")
public class SaveProjectUserActionCommentStrategy implements SaveProjectUserActionStrategy {
    ...
    public ProjectUserAction save(MediaUserActionDTO mediaUserActionDTO, Long subjectId) {
        ...
        projectUserActionStatistics.setCommentsCount(projectUserActionStatistics.getCommentsCount()+1);
        projectUserActionStatistics.setLastCommentDate(System.currentTimeMillis());
