...
@Service("SaveProjectUserActionViewStrategy")
public class SaveProjectUserActionViewStrategy implements SaveProjectUserActionStrategy {
    ...
    public ProjectUserAction save(MediaUserActionDTO mediaUserActionDTO, Long subjectId) {
        ...
        projectUserActionStatistics.setViewCount(projectUserActionStatistics.getViewCount()+1);
        projectUserActionStatistics.setLastViewDate(System.currentTimeMillis());
