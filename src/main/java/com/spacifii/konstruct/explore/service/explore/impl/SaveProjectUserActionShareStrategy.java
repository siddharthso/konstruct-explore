...
@Service("SaveProjectUserActionShareStrategy")
public class SaveProjectUserActionShareStrategy implements SaveProjectUserActionStrategy {
    ...
    public ProjectUserAction save(MediaUserActionDTO mediaUserActionDTO, Long subjectId) {
        ...
        projectUserActionStatistics.setShareCount(projectUserActionStatistics.getShareCount()+1);
        projectUserActionStatistics.setLastShareDate(System.currentTimeMillis());
