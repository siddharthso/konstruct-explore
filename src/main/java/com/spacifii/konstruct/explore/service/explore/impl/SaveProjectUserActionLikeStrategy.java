...
@Service("SaveProjectUserLikeStrategy")
public class SaveProjectUserActionLikeStrategy implements SaveProjectUserActionStrategy {
    ...
    public ProjectUserAction save(MediaUserActionDTO mediaUserActionDTO, Long subjectId) {
        ...
        projectUserActionStatistics.setLikeCount(projectUserActionStatistics.getLikeCount()+1);
        projectUserActionStatistics.setLastLikeDate(System.currentTimeMillis());
