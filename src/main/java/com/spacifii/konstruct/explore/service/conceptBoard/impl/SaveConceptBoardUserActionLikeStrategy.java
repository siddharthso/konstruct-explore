...
@Service("SaveConceptBoardUserActionLikeStrategy")
public class SaveConceptBoardUserActionLikeStrategy implements SaveConceptBoardUserActionStrategy {
    ...
    public ConceptBoardUserAction save(MediaUserActionDTO mediaUserActionDTO, Long subjectId) {
        ...
        ConceptBoardUserActionStatistics conceptBoardUserActionStatistics = conceptBoard.getConceptBoardUserActionStatistics();conceptBoardUserActionStatistics.setLikeCount(conceptBoardUserActionStatistics.getLikeCount()+1);
    ...
    public Boolean delete(ConceptBoardUserAction conceptBoardUserAction, Long subjectId) {
        ...
        conceptBoardUserActionStatistics.setLikeCount(conceptBoardUserActionStatistics.getLikeCount()-1);
        conceptBoard.setConceptBoardUserActionStatistics(conceptBoardUserActionStatistics);
        conceptBoardRepository.save(conceptBoard);
