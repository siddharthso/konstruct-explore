...
@Service("SaveConceptBoardUserActionQuestionStrategy")
public class SaveConceptBoardUserActionQuestionStrategy implements SaveConceptBoardUserActionStrategy {
    ...
    public ConceptBoardUserAction save(MediaUserActionDTO mediaUserActionDTO, Long subjectId) {
        ...
        conceptBoardUserActionStatistics.setQuestionCount(conceptBoardUserActionStatistics.getQuestionCount()+1);
