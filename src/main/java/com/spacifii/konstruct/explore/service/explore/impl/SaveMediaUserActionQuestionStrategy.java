...
@Service("SaveMediaUserActionQuestionStrategy")
public class SaveMediaUserActionQuestionStrategy implements SaveMediaUserActionStrategy {
    ...
    public MediaUserAction save(MediaUserActionDTO mediaUserActionDTO, Long subjectId) {
        ...
        mediaUserActionStatistics.setQuestionCount(mediaUserActionStatistics.getQuestionCount()+1);
        mediaUserActionStatistics.setLastQuestionDate(System.currentTimeMillis());
