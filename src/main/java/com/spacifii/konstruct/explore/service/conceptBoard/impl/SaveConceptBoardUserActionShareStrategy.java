...
@Service("SaveConceptBoardUserActionShareStrategy")
public class SaveConceptBoardUserActionShareStrategy implements SaveConceptBoardUserActionStrategy {
    ...
    public ConceptBoardUserAction save(MediaUserActionDTO mediaUserActionDTO, Long subjectId) {
        ...
        ConceptBoardUserActionStatistics conceptBoardUserActionStatistics = conceptBoard.getConceptBoardUserActionStatistics();conceptBoardUserActionStatistics.setShareCount(conceptBoardUserActionStatistics.getShareCount()+1);
    ...
    public Boolean delete(ConceptBoardUserAction conceptBoardUserAction, Long subjectId) {
        ...
        conceptBoardUserActionStatistics.setShareCount(conceptBoardUserActionStatistics.getShareCount()+1);
        conceptBoard.setConceptBoardUserActionStatistics(conceptBoardUserActionStatistics);
        conceptBoardRepository.save(conceptBoard);
