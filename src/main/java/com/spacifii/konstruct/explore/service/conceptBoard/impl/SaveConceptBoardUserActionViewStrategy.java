...
@Service("SaveConceptBoardUserActionViewStrategy")
public class SaveConceptBoardUserActionViewStrategy implements SaveConceptBoardUserActionStrategy {
    ...
    public ConceptBoardUserAction save(MediaUserActionDTO mediaUserActionDTO, Long subjectId) {
        ...
        ConceptBoardUserActionStatistics conceptBoardUserActionStatistics = conceptBoard.getConceptBoardUserActionStatistics();conceptBoardUserActionStatistics.setViewCount(conceptBoardUserActionStatistics.getViewCount()+1);
    ...
    public Boolean delete(ConceptBoardUserAction conceptBoardUserAction, Long subjectId) {
        ...
        conceptBoardUserActionStatistics.setViewCount(conceptBoardUserActionStatistics.getViewCount()-1);
        conceptBoard.setConceptBoardUserActionStatistics(conceptBoardUserActionStatistics);
        conceptBoardRepository.save(conceptBoard);
